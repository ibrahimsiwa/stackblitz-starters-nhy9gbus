...
export default function Home() {
  ...
  if (role === 'visitor') {
    return <Storefront setRole={setRole} products={products} heroBanner={heroBanner} />;
  }

  return (
    <div className="min-h-screen bg-siwa-beige flex flex-col items-center justify-center gap-6 p-10">
      <h1 className="text-3xl font-black text-siwa-spring">ابن شالي</h1>

      <button
        onClick={() => setRole('visitor')}
        className="bg-siwa-spring text-white px-8 py-4 rounded-xl font-bold text-lg"
      >
        المتجر
      </button>
      ...
      <button
        ...
        className="bg-siwa-brown text-white px-8 py-4 rounded-xl font-bold text-lg"
      >
        الكاشير
      </button>
      ...
      <button
        ...
        className="bg-siwa-gold text-white px-8 py-4 rounded-xl font-bold text-lg"
      >
        الإدارة
      </button>
    </div>
