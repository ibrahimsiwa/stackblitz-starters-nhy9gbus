...
interface Cashier2Props {
  ...
  setCart: (cart: { id: number; name: string; price: number; count: number }[] | ((prev: { id: number; name: string; price: number; count: number }[]) => { id: number; name: string; price: number; count: number }[])) => void;
  products: any[];
  expenses: any[];
  setExpenses: any;
  customers: any[];
